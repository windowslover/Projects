##   Purpose:  This function generates transects along a line with a specified distance between them at a specified distance
##
##   Transect tool acquired from http://gis4geomorphology.com/stream-transects-partial/
##
##   Adapted into a function to be included in other scripts by Jason Bartling


def generate_transects(workspacePath, lineFL, splitType, distanceBetweenTransects, transectWidth, widthUnit, outputFC):
    import arcpy
    import math
